...
import { fetchedData, filteredData, addLikes } from './redux/action';
...
const PicturesData = () => {
    ...
    // const likeNos = useSelector((state) => )
    ...
    const likesCount = (picture) => {
        dispatch(addLikes(picture.id));
    }
                                ...
                                <div className="col-md-3 mb-4">
                                    <div className="card h-100">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text lead" onClick={(e) => likesCount(picture)} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
